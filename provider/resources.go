...
import (
	...
	aquasec "github.com/aquasecurity/terraform-provider-aquasec/aquasec"
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"aquasec_host_assurance_policy":     {Tok: tfbridge.MakeResource(mainPkg, mainMod, "HostAssurancePolic")},
