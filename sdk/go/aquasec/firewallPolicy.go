...
// Username of the account that created the policy.
func (o FirewallPolicyOutput) Author() pulumi.StringOutput {
	return o.ApplyT(func(v *FirewallPolicy) pulumi.StringOutput { return v.Author }).(pulumi.StringOutput)
}

// Indicates whether policy includes blocking incoming 'ping' requests.
func (o FirewallPolicyOutput) BlockIcmpPing() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *FirewallPolicy) pulumi.BoolPtrOutput { return v.BlockIcmpPing }).(pulumi.BoolPtrOutput)
}

// Indicates whether policy includes blocking metadata services of the cloud.
func (o FirewallPolicyOutput) BlockMetadataService() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *FirewallPolicy) pulumi.BoolPtrOutput { return v.BlockMetadataService }).(pulumi.BoolPtrOutput)
}
...
// Information on network addresses that are allowed to pass in data or requests.
func (o FirewallPolicyOutput) InboundNetworks() FirewallPolicyInboundNetworkArrayOutput {
	return o.ApplyT(func(v *FirewallPolicy) FirewallPolicyInboundNetworkArrayOutput { return v.InboundNetworks }).(FirewallPolicyInboundNetworkArrayOutput)
}

// Timestamp of the last update in Unix time format.
func (o FirewallPolicyOutput) Lastupdate() pulumi.IntOutput {
	return o.ApplyT(func(v *FirewallPolicy) pulumi.IntOutput { return v.Lastupdate }).(pulumi.IntOutput)
}
...
// Information on network addresses that are allowed to receive data or requests.
func (o FirewallPolicyOutput) OutboundNetworks() FirewallPolicyOutboundNetworkArrayOutput {
	return o.ApplyT(func(v *FirewallPolicy) FirewallPolicyOutboundNetworkArrayOutput { return v.OutboundNetworks }).(FirewallPolicyOutboundNetworkArrayOutput)
}
...
// Aqua version functionality supported
func (o FirewallPolicyOutput) Version() pulumi.StringOutput {
	return o.ApplyT(func(v *FirewallPolicy) pulumi.StringOutput { return v.Version }).(pulumi.StringOutput)
}
