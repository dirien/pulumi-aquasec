...
// What type of assurance policy is described.
func (o FunctionAssurancePolicyOutput) AssuranceType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FunctionAssurancePolicy) pulumi.StringPtrOutput { return v.AssuranceType }).(pulumi.StringPtrOutput)
}
