...
// What type of assurance policy is described.
func (o KubernetesAssurancePolicyOutput) AssuranceType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KubernetesAssurancePolicy) pulumi.StringPtrOutput { return v.AssuranceType }).(pulumi.StringPtrOutput)
}
