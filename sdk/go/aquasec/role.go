...
func (o RoleOutput) Author() pulumi.StringOutput {
	return o.ApplyT(func(v *Role) pulumi.StringOutput { return v.Author }).(pulumi.StringOutput)
}
...
func (o RoleOutput) Permission() pulumi.StringOutput {
	return o.ApplyT(func(v *Role) pulumi.StringOutput { return v.Permission }).(pulumi.StringOutput)
}
...
func (o RoleOutput) Scopes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Role) pulumi.StringArrayOutput { return v.Scopes }).(pulumi.StringArrayOutput)
}
