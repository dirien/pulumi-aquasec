...
import com.pulumiverse.aquasec.FunctionAssurancePolicyArgs;
import com.pulumiverse.aquasec.Utilities;
import com.pulumiverse.aquasec.inputs.FunctionAssurancePolicyState;
import com.pulumiverse.aquasec.outputs.FunctionAssurancePolicyAutoScanTime;
import com.pulumiverse.aquasec.outputs.FunctionAssurancePolicyCustomCheck;
import com.pulumiverse.aquasec.outputs.FunctionAssurancePolicyForbiddenLabel;
import com.pulumiverse.aquasec.outputs.FunctionAssurancePolicyPackagesBlackList;
import com.pulumiverse.aquasec.outputs.FunctionAssurancePolicyPackagesWhiteList;
import com.pulumiverse.aquasec.outputs.FunctionAssurancePolicyRequiredLabel;
import com.pulumiverse.aquasec.outputs.FunctionAssurancePolicyScope;
import com.pulumiverse.aquasec.outputs.FunctionAssurancePolicyTrustedBaseImage;
...
@ResourceType(type="aquasec:index/functionAssurancePolicy:FunctionAssurancePolicy")
public class FunctionAssurancePolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="autoScanTimes", type=List.class, parameters={FunctionAssurancePolicyAutoScanTime.class})
    private Output<List<FunctionAssurancePolicyAutoScanTime>> autoScanTimes;

    public Output<List<FunctionAssurancePolicyAutoScanTime>> autoScanTimes() {
     ...
     * 
     */
    @Export(name="customChecks", type=List.class, parameters={FunctionAssurancePolicyCustomCheck.class})
    private Output</* @Nullable */ List<FunctionAssurancePolicyCustomCheck>> customChecks;

    /**
     * @return List of Custom user scripts for checks.
     * 
     */
    public Output<Optional<List<FunctionAssurancePolicyCustomCheck>>> customChecks() {
    ...
    @Export(name="forbiddenLabels", type=List.class, parameters={FunctionAssurancePolicyForbiddenLabel.class})
    private Output</* @Nullable */ List<FunctionAssurancePolicyForbiddenLabel>> forbiddenLabels;

    public Output<Optional<List<FunctionAssurancePolicyForbiddenLabel>>> forbiddenLabels() {
     ...
     * 
     */
    @Export(name="packagesBlackLists", type=List.class, parameters={FunctionAssurancePolicyPackagesBlackList.class})
    private Output</* @Nullable */ List<FunctionAssurancePolicyPackagesBlackList>> packagesBlackLists;

    /**
     * @return List of backlisted images.
     * 
     */
    public Output<Optional<List<FunctionAssurancePolicyPackagesBlackList>>> packagesBlackLists() {
     ...
     * 
     */
    @Export(name="packagesWhiteLists", type=List.class, parameters={FunctionAssurancePolicyPackagesWhiteList.class})
    private Output</* @Nullable */ List<FunctionAssurancePolicyPackagesWhiteList>> packagesWhiteLists;

    /**
     * @return List of whitelisted images.
     * 
     */
    public Output<Optional<List<FunctionAssurancePolicyPackagesWhiteList>>> packagesWhiteLists() {
    ...
    @Export(name="requiredLabels", type=List.class, parameters={FunctionAssurancePolicyRequiredLabel.class})
    private Output</* @Nullable */ List<FunctionAssurancePolicyRequiredLabel>> requiredLabels;

    public Output<Optional<List<FunctionAssurancePolicyRequiredLabel>>> requiredLabels() {
    ...
    @Export(name="scopes", type=List.class, parameters={FunctionAssurancePolicyScope.class})
    private Output<List<FunctionAssurancePolicyScope>> scopes;

    public Output<List<FunctionAssurancePolicyScope>> scopes() {
        return this.scopes;
    }
    /**
     ...
     * 
     */
    @Export(name="trustedBaseImages", type=List.class, parameters={FunctionAssurancePolicyTrustedBaseImage.class})
    private Output</* @Nullable */ List<FunctionAssurancePolicyTrustedBaseImage>> trustedBaseImages;

    /**
     * @return List of trusted images.
     * 
     */
    public Output<Optional<List<FunctionAssurancePolicyTrustedBaseImage>>> trustedBaseImages() {
     ...
     */
    public FunctionAssurancePolicy(String name) {
        this(name, FunctionAssurancePolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FunctionAssurancePolicy(String name, FunctionAssurancePolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aquasec:index/functionAssurancePolicy:FunctionAssurancePolicy", name, args == null ? FunctionAssurancePolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FunctionAssurancePolicy(String name, Output<String> id, @Nullable FunctionAssurancePolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aquasec:index/functionAssurancePolicy:FunctionAssurancePolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static FunctionAssurancePolicy get(String name, Output<String> id, @Nullable FunctionAssurancePolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
