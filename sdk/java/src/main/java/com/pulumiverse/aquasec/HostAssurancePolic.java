...
import com.pulumiverse.aquasec.HostAssurancePolicArgs;
import com.pulumiverse.aquasec.Utilities;
import com.pulumiverse.aquasec.inputs.HostAssurancePolicState;
import com.pulumiverse.aquasec.outputs.HostAssurancePolicAutoScanTime;
import com.pulumiverse.aquasec.outputs.HostAssurancePolicCustomCheck;
import com.pulumiverse.aquasec.outputs.HostAssurancePolicForbiddenLabel;
import com.pulumiverse.aquasec.outputs.HostAssurancePolicPackagesBlackList;
import com.pulumiverse.aquasec.outputs.HostAssurancePolicPackagesWhiteList;
import com.pulumiverse.aquasec.outputs.HostAssurancePolicRequiredLabel;
import com.pulumiverse.aquasec.outputs.HostAssurancePolicScope;
import com.pulumiverse.aquasec.outputs.HostAssurancePolicTrustedBaseImage;
...
@ResourceType(type="aquasec:index/hostAssurancePolic:HostAssurancePolic")
public class HostAssurancePolic extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="autoScanTimes", type=List.class, parameters={HostAssurancePolicAutoScanTime.class})
    private Output<List<HostAssurancePolicAutoScanTime>> autoScanTimes;

    public Output<List<HostAssurancePolicAutoScanTime>> autoScanTimes() {
     ...
     * 
     */
    @Export(name="customChecks", type=List.class, parameters={HostAssurancePolicCustomCheck.class})
    private Output</* @Nullable */ List<HostAssurancePolicCustomCheck>> customChecks;

    /**
     * @return List of Custom user scripts for checks.
     * 
     */
    public Output<Optional<List<HostAssurancePolicCustomCheck>>> customChecks() {
    ...
    @Export(name="forbiddenLabels", type=List.class, parameters={HostAssurancePolicForbiddenLabel.class})
    private Output</* @Nullable */ List<HostAssurancePolicForbiddenLabel>> forbiddenLabels;

    public Output<Optional<List<HostAssurancePolicForbiddenLabel>>> forbiddenLabels() {
     ...
     * 
     */
    @Export(name="packagesBlackLists", type=List.class, parameters={HostAssurancePolicPackagesBlackList.class})
    private Output</* @Nullable */ List<HostAssurancePolicPackagesBlackList>> packagesBlackLists;

    /**
     * @return List of backlisted images.
     * 
     */
    public Output<Optional<List<HostAssurancePolicPackagesBlackList>>> packagesBlackLists() {
     ...
     * 
     */
    @Export(name="packagesWhiteLists", type=List.class, parameters={HostAssurancePolicPackagesWhiteList.class})
    private Output</* @Nullable */ List<HostAssurancePolicPackagesWhiteList>> packagesWhiteLists;

    /**
     * @return List of whitelisted images.
     * 
     */
    public Output<Optional<List<HostAssurancePolicPackagesWhiteList>>> packagesWhiteLists() {
    ...
    @Export(name="requiredLabels", type=List.class, parameters={HostAssurancePolicRequiredLabel.class})
    private Output</* @Nullable */ List<HostAssurancePolicRequiredLabel>> requiredLabels;

    public Output<Optional<List<HostAssurancePolicRequiredLabel>>> requiredLabels() {
    ...
    @Export(name="scopes", type=List.class, parameters={HostAssurancePolicScope.class})
    private Output<List<HostAssurancePolicScope>> scopes;

    public Output<List<HostAssurancePolicScope>> scopes() {
        return this.scopes;
    }
    /**
     ...
     * 
     */
    @Export(name="trustedBaseImages", type=List.class, parameters={HostAssurancePolicTrustedBaseImage.class})
    private Output</* @Nullable */ List<HostAssurancePolicTrustedBaseImage>> trustedBaseImages;

    /**
     * @return List of trusted images.
     * 
     */
    public Output<Optional<List<HostAssurancePolicTrustedBaseImage>>> trustedBaseImages() {
     ...
     */
    public HostAssurancePolic(String name) {
        this(name, HostAssurancePolicArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HostAssurancePolic(String name, HostAssurancePolicArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HostAssurancePolic(String name, HostAssurancePolicArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aquasec:index/hostAssurancePolic:HostAssurancePolic", name, args == null ? HostAssurancePolicArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HostAssurancePolic(String name, Output<String> id, @Nullable HostAssurancePolicState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aquasec:index/hostAssurancePolic:HostAssurancePolic", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static HostAssurancePolic get(String name, Output<String> id, @Nullable HostAssurancePolicState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
