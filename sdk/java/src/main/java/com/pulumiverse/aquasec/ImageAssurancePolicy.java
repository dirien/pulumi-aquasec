...
public class ImageAssurancePolicy extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="autoScanTimes", refs={List.class,ImageAssurancePolicyAutoScanTime.class}, tree="[0,1]")
     ...
     * 
     */
    @Export(name="customChecks", refs={List.class,ImageAssurancePolicyCustomCheck.class}, tree="[0,1]")
    ...
    @Export(name="forbiddenLabels", refs={List.class,ImageAssurancePolicyForbiddenLabel.class}, tree="[0,1]")
     ...
     * 
     */
    @Export(name="packagesBlackLists", refs={List.class,ImageAssurancePolicyPackagesBlackList.class}, tree="[0,1]")
     ...
     * 
     */
    @Export(name="packagesWhiteLists", refs={List.class,ImageAssurancePolicyPackagesWhiteList.class}, tree="[0,1]")
    ...
    @Export(name="requiredLabels", refs={List.class,ImageAssurancePolicyRequiredLabel.class}, tree="[0,1]")
    ...
    @Export(name="scopes", refs={List.class,ImageAssurancePolicyScope.class}, tree="[0,1]")
     ...
     * 
     */
    @Export(name="trustedBaseImages", refs={List.class,ImageAssurancePolicyTrustedBaseImage.class}, tree="[0,1]")
