...
import com.pulumiverse.aquasec.ProviderArgs;
 ...
 * 
 */
@ResourceType(type="pulumi:providers:aquasec")
public class Provider extends com.pulumi.resources.ProviderResource {
     ...
     * 
     */
    public Output<Optional<String>> aquaUrl() {
        return Codegen.optional(this.aquaUrl);
    }
    /**
    ...
    public Provider(String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aquasec", name, args == null ? ProviderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
