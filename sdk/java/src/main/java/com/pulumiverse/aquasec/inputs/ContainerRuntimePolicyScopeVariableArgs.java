...
public final class ContainerRuntimePolicyScopeVariableArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final ContainerRuntimePolicyScopeVariableArgs Empty = new ContainerRuntimePolicyScopeVariableArgs();
    ...
    private ContainerRuntimePolicyScopeVariableArgs() {}
    ...
    public static Builder builder(ContainerRuntimePolicyScopeVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ContainerRuntimePolicyScopeVariableArgs();
        }

        public Builder(ContainerRuntimePolicyScopeVariableArgs defaults) {
            $ = new ContainerRuntimePolicyScopeVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ContainerRuntimePolicyScopeVariableArgs build() {
