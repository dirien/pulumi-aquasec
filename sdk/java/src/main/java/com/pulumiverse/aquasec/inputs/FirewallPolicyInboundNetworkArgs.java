...
public final class FirewallPolicyInboundNetworkArgs extends com.pulumi.resources.ResourceArgs {

    public static final FirewallPolicyInboundNetworkArgs Empty = new FirewallPolicyInboundNetworkArgs();
    ...
    private FirewallPolicyInboundNetworkArgs() {}

    private FirewallPolicyInboundNetworkArgs(FirewallPolicyInboundNetworkArgs $) {
        this.allow = $.allow;
    ...
    public static Builder builder(FirewallPolicyInboundNetworkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirewallPolicyInboundNetworkArgs();
        }

        public Builder(FirewallPolicyInboundNetworkArgs defaults) {
            $ = new FirewallPolicyInboundNetworkArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param allow Indicates whether the specified resources are allowed to pass in data or requests.
         * 
         * @return builder
         * 
         */
        ...
        public FirewallPolicyInboundNetworkArgs build() {
