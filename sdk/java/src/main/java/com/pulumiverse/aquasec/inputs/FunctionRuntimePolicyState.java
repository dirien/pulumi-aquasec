...
public final class FunctionRuntimePolicyState extends com.pulumi.resources.ResourceArgs {

    public static final FunctionRuntimePolicyState Empty = new FunctionRuntimePolicyState();
    ...
    private FunctionRuntimePolicyState() {}

    private FunctionRuntimePolicyState(FunctionRuntimePolicyState $) {
    ...
    public static Builder builder(FunctionRuntimePolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionRuntimePolicyState();
        }

        public Builder(FunctionRuntimePolicyState defaults) {
            $ = new FunctionRuntimePolicyState(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionRuntimePolicyState build() {
            return $;
        }
    }
