...
public final class GetFunctionAssurancePolicyPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFunctionAssurancePolicyPlainArgs Empty = new GetFunctionAssurancePolicyPlainArgs();
    ...
    private GetFunctionAssurancePolicyPlainArgs() {}

    private GetFunctionAssurancePolicyPlainArgs(GetFunctionAssurancePolicyPlainArgs $) {
    ...
    public static Builder builder(GetFunctionAssurancePolicyPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFunctionAssurancePolicyPlainArgs();
        }

        public Builder(GetFunctionAssurancePolicyPlainArgs defaults) {
            $ = new GetFunctionAssurancePolicyPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFunctionAssurancePolicyPlainArgs build() {
