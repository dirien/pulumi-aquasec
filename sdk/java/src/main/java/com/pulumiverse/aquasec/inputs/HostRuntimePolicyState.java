...
public final class HostRuntimePolicyState extends com.pulumi.resources.ResourceArgs {

    public static final HostRuntimePolicyState Empty = new HostRuntimePolicyState();
    ...
    private HostRuntimePolicyState() {}

    private HostRuntimePolicyState(HostRuntimePolicyState $) {
    ...
    public static Builder builder(HostRuntimePolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostRuntimePolicyState();
        }

        public Builder(HostRuntimePolicyState defaults) {
            $ = new HostRuntimePolicyState(Objects.requireNonNull(defaults));
        }
        ...
        public HostRuntimePolicyState build() {
            return $;
        }
    }
