...
public final class IntegrationRegistryState extends com.pulumi.resources.ResourceArgs {

    public static final IntegrationRegistryState Empty = new IntegrationRegistryState();
    ...
    private IntegrationRegistryState() {}
    ...
    public static Builder builder(IntegrationRegistryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntegrationRegistryState();
        }

        public Builder(IntegrationRegistryState defaults) {
            $ = new IntegrationRegistryState(Objects.requireNonNull(defaults));
        }
        ...
        public IntegrationRegistryState build() {
            return $;
        }
    }
