...
public final class RoleMappingOpenidArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleMappingOpenidArgs Empty = new RoleMappingOpenidArgs();
    ...
    private RoleMappingOpenidArgs() {}

    private RoleMappingOpenidArgs(RoleMappingOpenidArgs $) {
    ...
    public static Builder builder(RoleMappingOpenidArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleMappingOpenidArgs();
        }

        public Builder(RoleMappingOpenidArgs defaults) {
            $ = new RoleMappingOpenidArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RoleMappingOpenidArgs build() {
