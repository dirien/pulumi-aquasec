...
@CustomType
public final class FunctionAssurancePolicyCustomCheck {
    /**
    ...
    public static Builder builder(FunctionAssurancePolicyCustomCheck defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FunctionAssurancePolicyCustomCheck defaults) {
        ...
        public Builder snippet(@Nullable String snippet) {
            this.snippet = snippet;
            return this;
        }        public FunctionAssurancePolicyCustomCheck build() {
            return new FunctionAssurancePolicyCustomCheck(author, description, engine, lastModified, name, path, readOnly, scriptId, severity, snippet);
        }
    }
}
