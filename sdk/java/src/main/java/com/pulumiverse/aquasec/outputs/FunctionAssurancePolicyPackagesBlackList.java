...
@CustomType
public final class FunctionAssurancePolicyPackagesBlackList {
    ...
    public static Builder builder(FunctionAssurancePolicyPackagesBlackList defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FunctionAssurancePolicyPackagesBlackList defaults) {
        ...
        public Builder versionRange(@Nullable String versionRange) {
            this.versionRange = versionRange;
            return this;
        }        public FunctionAssurancePolicyPackagesBlackList build() {
            return new FunctionAssurancePolicyPackagesBlackList(arch, display, epoch, format, license, name, release, version, versionRange);
        }
    }
}
