...
@CustomType
public final class FunctionAssurancePolicyPackagesWhiteList {
    ...
    public static Builder builder(FunctionAssurancePolicyPackagesWhiteList defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FunctionAssurancePolicyPackagesWhiteList defaults) {
        ...
        public Builder versionRange(@Nullable String versionRange) {
            this.versionRange = versionRange;
            return this;
        }        public FunctionAssurancePolicyPackagesWhiteList build() {
            return new FunctionAssurancePolicyPackagesWhiteList(arch, display, epoch, format, license, name, release, version, versionRange);
        }
    }
}
