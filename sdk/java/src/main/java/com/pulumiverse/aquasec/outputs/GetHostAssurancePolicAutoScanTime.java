...
@CustomType
public final class GetHostAssurancePolicAutoScanTime {
    ...
    private GetHostAssurancePolicAutoScanTime(
    ...
    public static Builder builder(GetHostAssurancePolicAutoScanTime defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetHostAssurancePolicAutoScanTime defaults) {
        ...
        }        public GetHostAssurancePolicAutoScanTime build() {
            return new GetHostAssurancePolicAutoScanTime(iteration, iterationType, time, weekDays);
        }
    }
}
