...
@CustomType
public final class GetHostAssurancePolicyAutoScanTime {
    ...
    private GetHostAssurancePolicyAutoScanTime(
    ...
    public static Builder builder(GetHostAssurancePolicyAutoScanTime defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetHostAssurancePolicyAutoScanTime defaults) {
        ...
        }        public GetHostAssurancePolicyAutoScanTime build() {
            return new GetHostAssurancePolicyAutoScanTime(iteration, iterationType, time, weekDays);
        }
    }
}
