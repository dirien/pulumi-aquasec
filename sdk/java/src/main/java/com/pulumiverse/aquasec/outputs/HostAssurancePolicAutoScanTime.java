...
@CustomType
public final class HostAssurancePolicAutoScanTime {
    ...
    private HostAssurancePolicAutoScanTime(
    ...
    public static Builder builder(HostAssurancePolicAutoScanTime defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HostAssurancePolicAutoScanTime defaults) {
        ...
        }        public HostAssurancePolicAutoScanTime build() {
            return new HostAssurancePolicAutoScanTime(iteration, iterationType, time, weekDays);
        }
    }
}
