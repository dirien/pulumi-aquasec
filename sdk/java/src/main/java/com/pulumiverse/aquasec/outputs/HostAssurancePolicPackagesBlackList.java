...
@CustomType
public final class HostAssurancePolicPackagesBlackList {
    ...
    private HostAssurancePolicPackagesBlackList(
    ...
    public static Builder builder(HostAssurancePolicPackagesBlackList defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HostAssurancePolicPackagesBlackList defaults) {
        ...
        public Builder versionRange(@Nullable String versionRange) {
            this.versionRange = versionRange;
            return this;
        }        public HostAssurancePolicPackagesBlackList build() {
            return new HostAssurancePolicPackagesBlackList(arch, display, epoch, format, license, name, release, version, versionRange);
        }
    }
}
