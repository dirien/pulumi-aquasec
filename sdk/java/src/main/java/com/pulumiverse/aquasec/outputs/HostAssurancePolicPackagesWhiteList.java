...
@CustomType
public final class HostAssurancePolicPackagesWhiteList {
    ...
    private HostAssurancePolicPackagesWhiteList(
    ...
    public static Builder builder(HostAssurancePolicPackagesWhiteList defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HostAssurancePolicPackagesWhiteList defaults) {
        ...
        public Builder versionRange(@Nullable String versionRange) {
            this.versionRange = versionRange;
            return this;
        }        public HostAssurancePolicPackagesWhiteList build() {
            return new HostAssurancePolicPackagesWhiteList(arch, display, epoch, format, license, name, release, version, versionRange);
        }
    }
}
