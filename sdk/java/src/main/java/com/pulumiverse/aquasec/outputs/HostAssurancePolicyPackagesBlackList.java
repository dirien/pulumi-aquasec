...
@CustomType
public final class HostAssurancePolicyPackagesBlackList {
    ...
    public static Builder builder(HostAssurancePolicyPackagesBlackList defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HostAssurancePolicyPackagesBlackList defaults) {
        ...
        public Builder versionRange(@Nullable String versionRange) {
            this.versionRange = versionRange;
            return this;
        }        public HostAssurancePolicyPackagesBlackList build() {
            return new HostAssurancePolicyPackagesBlackList(arch, display, epoch, format, license, name, release, version, versionRange);
        }
    }
}
