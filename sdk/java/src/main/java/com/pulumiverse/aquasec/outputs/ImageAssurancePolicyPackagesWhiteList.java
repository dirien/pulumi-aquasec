...
@CustomType
public final class ImageAssurancePolicyPackagesWhiteList {
    ...
    public static Builder builder(ImageAssurancePolicyPackagesWhiteList defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ImageAssurancePolicyPackagesWhiteList defaults) {
        ...
        public Builder versionRange(@Nullable String versionRange) {
            this.versionRange = versionRange;
            return this;
        }        public ImageAssurancePolicyPackagesWhiteList build() {
            return new ImageAssurancePolicyPackagesWhiteList(arch, display, epoch, format, license, name, release, version, versionRange);
        }
    }
}
