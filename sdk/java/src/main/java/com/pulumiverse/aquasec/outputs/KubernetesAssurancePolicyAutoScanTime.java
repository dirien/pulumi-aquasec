...
@CustomType
public final class KubernetesAssurancePolicyAutoScanTime {
    ...
    private KubernetesAssurancePolicyAutoScanTime(
    ...
    public static Builder builder(KubernetesAssurancePolicyAutoScanTime defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KubernetesAssurancePolicyAutoScanTime defaults) {
        ...
        }        public KubernetesAssurancePolicyAutoScanTime build() {
            return new KubernetesAssurancePolicyAutoScanTime(iteration, iterationType, time, weekDays);
        }
    }
}
