...
export function getHostAssurancePolic(args: GetHostAssurancePolicArgs, opts?: pulumi.InvokeOptions): Promise<GetHostAssurancePolicResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("aquasec:index/getHostAssurancePolic:getHostAssurancePolic", {
 ...
 */
export interface GetHostAssurancePolicArgs {
    /**
 ...
 */
export interface GetHostAssurancePolicResult {
    /**
    ...
    readonly autoScanTimes: outputs.GetHostAssurancePolicAutoScanTime[];
    /**
     ...
     */
    readonly customChecks: outputs.GetHostAssurancePolicCustomCheck[];
    /**
    ...
    readonly forbiddenLabels: outputs.GetHostAssurancePolicForbiddenLabel[];
     ...
     */
    readonly packagesBlackLists: outputs.GetHostAssurancePolicPackagesBlackList[];
    /**
     ...
     */
    readonly packagesWhiteLists: outputs.GetHostAssurancePolicPackagesWhiteList[];
    ...
    readonly requiredLabels: outputs.GetHostAssurancePolicRequiredLabel[];
    ...
    readonly scopes: outputs.GetHostAssurancePolicScope[];
    /**
     * List of trusted images.
     */
    readonly trustedBaseImages: outputs.GetHostAssurancePolicTrustedBaseImage[];
    /**
...
export function getHostAssurancePolicOutput(args: GetHostAssurancePolicOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetHostAssurancePolicResult> {
    return pulumi.output(args).apply(a => getHostAssurancePolic(a, opts))
}

/**
 * A collection of arguments for invoking getHostAssurancePolic.
 */
export interface GetHostAssurancePolicOutputArgs {
    /**
     * Indicates that policy should ignore cases that do not have a known fix.
     */
