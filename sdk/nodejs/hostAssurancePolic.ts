...
export class HostAssurancePolic extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HostAssurancePolicState, opts?: pulumi.CustomResourceOptions): HostAssurancePolic {
        return new HostAssurancePolic(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aquasec:index/hostAssurancePolic:HostAssurancePolic';

    /**
     * Returns true if the given object is an instance of HostAssurancePolic.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HostAssurancePolic {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HostAssurancePolic.__pulumiType;
    }
    ...
    public readonly autoScanTimes!: pulumi.Output<outputs.HostAssurancePolicAutoScanTime[]>;
    /**
     ...
     */
    public readonly customChecks!: pulumi.Output<outputs.HostAssurancePolicCustomCheck[] | undefined>;
    /**
    ...
    public readonly forbiddenLabels!: pulumi.Output<outputs.HostAssurancePolicForbiddenLabel[] | undefined>;
     ...
     */
    public readonly packagesBlackLists!: pulumi.Output<outputs.HostAssurancePolicPackagesBlackList[] | undefined>;
    /**
     ...
     */
    public readonly packagesWhiteLists!: pulumi.Output<outputs.HostAssurancePolicPackagesWhiteList[] | undefined>;
    ...
    public readonly requiredLabels!: pulumi.Output<outputs.HostAssurancePolicRequiredLabel[] | undefined>;
    ...
    public readonly scopes!: pulumi.Output<outputs.HostAssurancePolicScope[]>;
    /**
     * List of trusted images.
     */
    public readonly trustedBaseImages!: pulumi.Output<outputs.HostAssurancePolicTrustedBaseImage[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: HostAssurancePolicArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HostAssurancePolicArgs | HostAssurancePolicState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HostAssurancePolicState | undefined;
            ...
            const args = argsOrState as HostAssurancePolicArgs | undefined;
        ...
        super(HostAssurancePolic.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface HostAssurancePolicState {
    /**
     * List of explicitly allowed images.
     */
    ...
    autoScanTimes?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicAutoScanTime>[]>;
    /**
     * List of function's forbidden permissions.
     */
     ...
     * List of Custom user scripts for checks.
     */
    customChecks?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicCustomCheck>[]>;
    /**
     * Indicates if scanning should include custom checks.
     */
    ...
    forbiddenLabels?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicForbiddenLabel>[]>;
     ...
     * List of backlisted images.
     */
    packagesBlackLists?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicPackagesBlackList>[]>;
    /**
     * Indicates if packages whitelist is relevant.
     */
     ...
     * List of whitelisted images.
     */
    packagesWhiteLists?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicPackagesWhiteList>[]>;
    ...
    requiredLabels?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicRequiredLabel>[]>;
    ...
    scopes?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicScope>[]>;
    /**
     * List of trusted images.
     */
    trustedBaseImages?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicTrustedBaseImage>[]>;
    /**
     * Indicates if list of trusted base images is relevant.
     */
 ...
 */
export interface HostAssurancePolicArgs {
    /**
     * List of explicitly allowed images.
     */
    allowedImages?: pulumi.Input<pulumi.Input<string>[]>;
