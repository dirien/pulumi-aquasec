...
export class KubernetesAssurancePolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KubernetesAssurancePolicyState, opts?: pulumi.CustomResourceOptions): KubernetesAssurancePolicy {
        return new KubernetesAssurancePolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aquasec:index/kubernetesAssurancePolicy:KubernetesAssurancePolicy';

    /**
     * Returns true if the given object is an instance of KubernetesAssurancePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubernetesAssurancePolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubernetesAssurancePolicy.__pulumiType;
    }
     ...
     */
    public readonly customChecks!: pulumi.Output<outputs.KubernetesAssurancePolicyCustomCheck[] | undefined>;
    /**
    ...
    public readonly scopes!: pulumi.Output<outputs.KubernetesAssurancePolicyScope[]>;
    /**
     * List of trusted images.
     */
    public readonly trustedBaseImages!: pulumi.Output<outputs.KubernetesAssurancePolicyTrustedBaseImage[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: KubernetesAssurancePolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KubernetesAssurancePolicyArgs | KubernetesAssurancePolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as KubernetesAssurancePolicyArgs | undefined;
...
export interface KubernetesAssurancePolicyState {
     ...
     * List of Custom user scripts for checks.
     */
    customChecks?: pulumi.Input<pulumi.Input<inputs.KubernetesAssurancePolicyCustomCheck>[]>;
    /**
     * Indicates if scanning should include custom checks.
     */
    ...
    scopes?: pulumi.Input<pulumi.Input<inputs.KubernetesAssurancePolicyScope>[]>;
    /**
     * List of trusted images.
     */
    trustedBaseImages?: pulumi.Input<pulumi.Input<inputs.KubernetesAssurancePolicyTrustedBaseImage>[]>;
    /**
     * Indicates if list of trusted base images is relevant.
     */
